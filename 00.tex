...
\makeatother 
\input{01_2017_Kliga}
\input{02_2017_Zlobin}
\input{03_2017_Shevchenko}
\input{04_2017_Pietrasiewicz}
\input{05_2017_Andreev}
\input{06_2017_Shamonin}
\input{07_2017_Wall}
\input{08_2017_Volchak}
\input{09_2017_Ermakova}
\input{10_2017_Stepanov}
\input{11_2017_Opasiak}
\input{12_2017_Hlebnikov}
\input{13_2017_Soroko}
\input{14_2017_Rewoonenco}
\input{15_2017_Svirinovski}
\input{16_2017_Savchenko}
\input{17_2017_Semernik}
\input{18_2017_Shiryaeva}
\input{19_2017_Savchenko}
\input{20_2017_Shigorin}
%\input{51_spons_hoster}
\input{50_spons_epam}
\input{48_spons_sams}
%\input{51_spons_its}
\input{52_spons_mycloud}
\input{55_interv_2017_pawel}
\input{56_interv_2017_meeks}
\input{57_interv_2017_muellner}
\newpage
