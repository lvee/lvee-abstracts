...
%[0] https://www.jwz.org/xscreensaver/screenshots/


\q Which GNU/Linux distro was your first one, if it wasn't already mentioned? 
Which distro (distros) are you using now? 

\a In case the umlaut in my name hasn't given it away already, I'm originally from Germany. Back in the day, SuSE was the dominating distribution there, so SuSE 6.1[0] was my very first Linux distro - purchased in a bookstore as a set of CD-ROMs. 
