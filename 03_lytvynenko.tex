...
\end{verbatim}
хутчэй, чым: \verb!map(lambda x,y: x+y, l1, l2)!. А спроба сабраць матрыцу ў адзін радок інструкцыяй \verb!collect_str+=a[i][j]! у цыкле істотна прайграе інструкцыі:
\begin{verbatim} 
...
Існуюць праекты статычных кампілятараў падмноства мовы Py\-thon у машынны код, напрыклад, \progname{Shedskin}. Праект \progname{PyPy}, акрамя іншых дастасаванняў, здольны статычна кампіляваць г.зв. падмноства RPython. На жаль, гэты падыход абмяжоўвае мажлівасці мовы (у прыватнасці, яго складана ўжыць для ўжо гатовага коду).
...
\item Праект \progname{PyPy}. Iнтэпрэтатар і JIT"=кампілятар. Хуткасць выканання расце ад версіі да версіі і ўжо перавышае хуткасць Psyco \cite{speed}. Ускладненая праца з вонкавымі бібліятэкамі на C.
...
\caption{Час выканання праграмы \progname{Mj{\"o}llnir}, сек.}\label{tab:benchmark}\\
\hline
